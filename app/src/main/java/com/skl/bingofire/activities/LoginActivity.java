...
public class LoginActivity extends BaseActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton = (Button) findViewById(R.id.signInButton);
        ...
        mLoginFormView = (ViewGroup)findViewById(R.id.login_form);
                            ...
                            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        ...
                                        Snackbar.make(mEmailView, "Failed to sign in account", Snackbar.LENGTH_LONG).show();
                                    }
                                }
                            });
                        } else {
                            showProgress(false);
                            Snackbar.make(mEmailView, "Failed to register account", Snackbar.LENGTH_LONG).show();
                        }
                    }
                });
